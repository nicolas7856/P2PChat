...
function createPC() {
    ...
    pc.onconnectionstatechange = () => {
        ...
        document.getElementById('connection-status').textContent = s ? 'CONNESSO' : 'Disconnesso';
        document.getElementById('connection-status').className = s ? 'status-connected' : 'status-disconnected';
        if(s) setTimeout(() => showScreen('chat'), 800);
    };
}
